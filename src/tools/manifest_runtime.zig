...
pub fn listToolsJsonAlloc(a: std.mem.Allocator, io: std.Io, plugin_dir: []const u8) ![]u8 {
    var dir = try std.Io.Dir.cwd().openDir(io, plugin_dir, .{});
    defer dir.close(io);
...
pub fn describeToolJsonAlloc(a: std.mem.Allocator, io: std.Io, plugin_dir: []const u8, tool: []const u8) ![]u8 {
